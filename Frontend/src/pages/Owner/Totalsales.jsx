...
const TotalSales = () => {
  ...
  return (
    <div style={{ border: "2px solid black", backgroundColor: "rgba(0, 123, 255, 0.4)", color: "black",borderRadius: "20px", marginTop: "5px", height: "250px", display: "flex", flexDirection: "column", justifyContent: "center", alignItems: "center"}}>
